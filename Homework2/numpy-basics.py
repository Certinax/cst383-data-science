...
# The width and height values for part 1 vary a little because
...
part_num = np.array(["part1", "part1", "part1", 
                     "part2", "part2", "part2",
                     "part3", "part3", "part3",])
...
# 'width', 'height', and parts.  The function should return a NumPy
# array that gives the distance from the point (width, height) to
